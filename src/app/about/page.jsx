    ...
    <div className='w-full h-full'>
      ...
      <div className='w-full flex flex-col justify-center items-center bg-[#F7ECEE] mt-5'>
       ...
       <p className='font-open-sans p-5 text-xl font-light leading-8 text-center font-w-300'>
        Welcome to <span className='font-bold'>The Novello by evergreen</span>, you re home away from home. Nestled in the Queen of hills <span className='font-bold'>Mussoorie Dehradun</span> , our hotel offers a perfect blend of modern comfort and warm, personalised service. Whether youre here for business, leisure, or a special occasion, we provide a unique experience that caters to your every need.
        <br/>
