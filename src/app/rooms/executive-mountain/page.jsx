      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 py-20">
        <div className="max-w-5xl w-full p-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 bg-white rounded-lg shadow-md overflow-hidden">
            ...
            {/* Booking Section */}
            <div className="p-4">
              <h2 className="text-2xl font-bold">Executive Rooms with Mountain View</h2>
              <p className="text-gray-600 mt-2">
                Indulge in luxury at our Executive Rooms with Mountain View at the heart of Mussoorie.
              </p>
              <div className="mt-4">
